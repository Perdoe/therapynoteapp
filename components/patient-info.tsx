...
import { ChevronDown, ChevronUp, MessageSquare, Calendar, Edit } from "lucide-react"
      ...
      <CardHeader className="pb-2">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-xl font-serif">Sarah Johnson</CardTitle>
              <CardDescription>28 • She/Her</CardDescription>
            </div>
          </div>
          <Button
            variant="ghost"
